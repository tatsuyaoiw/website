  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <header>
        ...
        <h2>Software engineer based in New York. Originally from Japan. Raising two little girls.</h2>
      </header>
      ...
      <p>Are you interested in working with me? Check out my <a href="https://github.com/tatsuyaoiw/resume/blob/master/resume-2021.pdf">resume</a> as well.</p>
